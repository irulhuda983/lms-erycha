...
const largeMenu = ref(true)
const route = useRoute()

</script>

<template>
    <div :class="largeMenu ? 'w-48':'w-16'" class="hidden lg:block h-full relative box-border flex items-center justify-center bg-white">
        <div class="w-full h-full box-border bg-white text-[#0d1216] flex items-center flex-col">
            <div class="mt-10 mb-3 w-full box-border px-3 flex space-x-3">
            ...
            <div class="w-full h-12 box-border relative cursor-pointer mb-5" @click.prevent="largeMenu = !largeMenu">
                <div class="w-8 h-8 rounded-full bg-white border border-gray-400 absolute flex items-center justify-center -right-3 text-gray-400 shadow-lg">
            ...
            <div class="w-full box-border px-3">
                ...
                >
                    ...
                    <div v-if="largeMenu">Master Data</div>
                </router-link>
                ...
                >
                    ...
                    <div v-if="largeMenu">Bank Soal</div>
                </router-link>
