    ...
    <div class="w-full box-border p-5">
        <div class="w-full relative overflow-x-auto shadow-md sm:rounded-lg bg-white">
            <div class="box-border px-6 py-6 border-b bg-white flex justify-between items-center">
                <h2 class="text-lg font-bold">Tambah Materi</h2>
            </div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="media-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed rounded-lg cursor-pointer bg-gray-50" :class="errors.media_file ? 'border-red-300':'border-gray-300'">
                                <div v-if="payload.media_file" class="flex flex-col items-center justify-center pt-5 pb-6" :class="mediaFile.files[0].type == 'application/pdf' ? 'text-red-500' : 'text-blue-500'">
                                    ...
                                    <div class="mt-2 text-gray-500 font-semibold text-center">{{ mediaFile.files[0].name }}</div>
                                </div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="media-video" class="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed rounded-lg cursor-pointer bg-gray-50" :class="errors.media_video ? 'border-red-300':'border-gray-300'">
                                <div v-if="payload.media_video" class="flex flex-col items-center justify-center pt-5 pb-6 text-red-500">
                                    ...
                                    <!-- mediaFile.files[0].type == 'application/pdf' -->
                                    <div class="mt-2 text-gray-500 font-semibold text-center">{{ mediaVideo.files[0].name }}</div>
                                </div>
            ...
            <div class="border-t px-6 py-4 box-order">
                ...
                <div class="flex justify-end" v-else>
                    <button @click="router.push({ name: 'materi' })" type="button" class="mr-5 text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                        Batal
                    </button>
